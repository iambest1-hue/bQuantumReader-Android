...
- 🛠️ **结果操作** — 预览渲染效果、复制到剪贴板、分享到其他 APP、保存为 .md 文件
- 💬 **评论提取** — 同步获取视频热门评论
...
2. 📂 在手机上打开 APK 文件
3. ⚠️ 如提示"未知来源应用"，前往设置允许安装
4. 🛡️ 首次打开可能提示"Google Play 保护机制" — 点击 **更多 → 仍要安装**
...
| 🏛️ 架构 | 单 Activity + ViewModel + Repository |
| 🌐 网络 | Retrofit + OkHttp |
| 🖼️ 图片 | Coil |
| 💉 依赖注入 | Koin |
